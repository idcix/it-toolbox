...
IT Toolbox 是面向开发者的在线工具箱，集成 96 款高频开发工具。基于 Cloudflare Pages Functions 全栈部署，前后端同域，无需传统服务器，全球边缘节点低延迟响应。
...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| 2.0.0 | 2026-03-24 | 更新架构文档，反映 96 款工具的实际状态，新增汇率/代理/AI Review API |
